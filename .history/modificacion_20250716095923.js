...
function addFacturaCard(facturaData = null) {
    ...
    '<div class="factura-form-group">' +
        '<label>Estado</label>' +
        '<div class="estado-checkboxes-inline">' +
...
'</div>' +
        ...
        '<div class="factura-form-group full-width">' +
            ...
            '<textarea class="form-textarea factura-comentarios" rows="1" placeholder="Comentarios adicionales..." data-field="comentarios">' + factura.comentarios + '</textarea>' +
        '</div>';
